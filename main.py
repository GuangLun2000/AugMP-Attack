...
def main(config_overrides: Optional[Dict] = None):
    config = {
        ...
        'lora_r': 256,  # LoRA rank (controls the rank of low-rank matrices). r=8 for speed, r=16/32 for better capacity
        'lora_alpha': 512,  # LoRA alpha (scaling factor, typically 2*r). Must match r: alpha=2*r
